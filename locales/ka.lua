...
Locale.Register('ka', {
    prompt = { open = 'გახსნა', gunsmith = '%{name}' },
    error = {
        nothing_to_inspect = 'დაათვალიერე იარაღი ხელში.', no_permission = 'ეს დახლი შენთვის არ არის.',
    ...
    command = { infiniteammo = 'უსასრულო მჭიდის ჩართვა/გამორთვა (ადმინი)' },
    info = {
        infinite_on = 'უსასრულო მჭიდი ჩართულია.', infinite_off = 'უსასრულო მჭიდი გამორთულია.',
