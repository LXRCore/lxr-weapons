...
Locale.Register('en', {
    ...
    error = {
        nothing_to_inspect = 'Hold a gun to look it over.', no_permission = 'This counter is not yours to use.',
    ...
    command = { infiniteammo = 'Toggle an endless clip (admin)' },
    info = {
        infinite_on = 'Endless clip on.', infinite_off = 'Endless clip off.',
